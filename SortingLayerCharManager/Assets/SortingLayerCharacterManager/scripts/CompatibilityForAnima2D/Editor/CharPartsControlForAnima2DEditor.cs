...
[CustomEditor(typeof(CharPartsControlForAnima2D))]
public class CharPartsControlForAnima2DEditor : Editor
{
    
    private CharPartsControlForAnima2D MyScript() { return (CharPartsControlForAnima2D)target; }
    private ReorderableList rl_meshObjList;
    private ReorderableList rl_subTagLayers;
    private ReorderableList rl_meshTarget;

    public void OnEnable() {
        CharPartsControlForAnima2D myScript = MyScript();
