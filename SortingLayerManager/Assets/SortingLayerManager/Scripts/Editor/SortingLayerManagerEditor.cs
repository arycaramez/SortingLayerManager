...
namespace SortingLayerManager
{
    ...
    public class SortingLayerManagerEditor : Editor
    {
        ...
        public void OnEnable()
        {
            ...
            {
                SortingLayerManager myScript = MyScript();
                ...
                element.stringValue =
                    EditorGUI.TextField(new Rect(rect.x, rect.y,
                        ...
                        "ID: " + index+" ("+ (myScript.layerBase-index) + ")", element.stringValue);
            };
            //myScript.meshTarget
            rl_meshTarget =
                new ReorderableList(
